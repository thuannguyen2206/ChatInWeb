...
namespace WebChat.DataAccess.Migrations
{
    ...
    [Migration("20210425091023_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebChat.Entities.Model.CallType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 4, 25, 16, 10, 22, 512, DateTimeKind.Local).AddTicks(4666),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2021, 4, 25, 16, 10, 22, 512, DateTimeKind.Local).AddTicks(6809),
            ...
            modelBuilder.Entity("WebChat.Entities.Model.ChatGroup", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 25, 16, 10, 22, 417, DateTimeKind.Local).AddTicks(3675));
            ...
            modelBuilder.Entity("WebChat.Entities.Model.ChatLog", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 25, 16, 10, 22, 422, DateTimeKind.Local).AddTicks(8013));
            ...
            modelBuilder.Entity("WebChat.Entities.Model.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("CreateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 25, 16, 10, 22, 448, DateTimeKind.Local).AddTicks(5199));
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 4, 25, 16, 10, 22, 548, DateTimeKind.Local).AddTicks(2220),
                            Description = "System"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2021, 4, 25, 16, 10, 22, 548, DateTimeKind.Local).AddTicks(3263),
                            Description = "Chat"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2021, 4, 25, 16, 10, 22, 548, DateTimeKind.Local).AddTicks(3285),
            ...
            modelBuilder.Entity("WebChat.Entities.Model.NotificationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 25, 16, 10, 22, 427, DateTimeKind.Local).AddTicks(9005));
            ...
            modelBuilder.Entity("WebChat.Entities.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "62fc28dc-0c3d-495d-bb31-d7ec916bb762",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "62a0bf0e-95d3-4de9-98f7-4a6d77747bac",
            ...
            modelBuilder.Entity("WebChat.Entities.Model.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 25, 16, 10, 22, 439, DateTimeKind.Local).AddTicks(6251));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "447743d4-e17c-4d53-a62b-b5887f3d1354",
                            DateCreate = new DateTime(2021, 4, 25, 16, 10, 22, 538, DateTimeKind.Local).AddTicks(1581),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEOJmkTos2JQk7mRO8c0NRDKCbnAeL/+Fze7MqOVLR+Oy3gEyHyvjXYEhwFTKGlGSQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "New York, US",
                            ConcurrencyStamp = "e9f34e24-7396-4213-aaef-66117d1ca050",
                            DateCreate = new DateTime(2021, 4, 25, 16, 10, 22, 547, DateTimeKind.Local).AddTicks(8235),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAfr6UcqJCDM/UfAxVfWpH4ZmUDczfjg3VoTqSbYlvnh/KaqVJxdw7l6xiRYvlkTyQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            Status = true,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("WebChat.Entities.Model.UserConnection", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 25, 16, 10, 22, 435, DateTimeKind.Local).AddTicks(5329));
            ...
            modelBuilder.Entity("WebChat.Entities.Model.Notification", b =>
                {
                    b.HasOne("WebChat.Entities.Model.NotificationType", "NotificationType")
